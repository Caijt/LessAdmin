  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create" type="primary" :disabled="!$permission.canWrite()">创建扣税规则</el-button>
      </template>
      <el-table-column
        slot="column"
        label="操作"
...
<script>
import list from "@/components/hr/wageTax/list";
import editDialog from "@/components/hr/wageTax/editDialog";
