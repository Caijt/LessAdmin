  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create" type="primary" :disabled="!$permission.canWrite()">创建调动记录</el-button>
      </template>
      <el-table-column
        slot="table"
        label="操作"
...
<script>
import list from "@/components/hr/mobilizeRecord/list";
import editDialog from "@/components/hr/mobilizeRecord/editDialog";
