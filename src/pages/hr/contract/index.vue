  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create" type="primary" :disabled="!$permission.canWrite()">创建员工合同</el-button>
      </template>
      <el-table-column
        slot="column"
        label="操作"
...
<script>
import list from "@/components/hr/contract/list";
import editDialog from "@/components/hr/contract/editDialog";
