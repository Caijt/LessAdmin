  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create" type="primary" :disabled="!$permission.canWrite()">创建工资项目</el-button>
      </template>
      <el-table-column
        slot="column"
        label="操作"
...
<script>
import list from "@/components/hr/wageItem/list";
import editDialog from "@/components/hr/wageItem/editDialog";
