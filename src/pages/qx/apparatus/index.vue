  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create" type="primary" :disabled="!$permission.canWrite()">创建器械档案</el-button>
      </template>
      <el-table-column
        slot="table"
        label="操作"
...
<script>
import list from "@/components/qx/apparatus/list";
import editDialog from "@/components/qx/apparatus/editDialog";
