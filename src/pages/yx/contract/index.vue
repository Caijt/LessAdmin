  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create" type="primary" :disabled="!$permission.canWrite()">添加合同信息</el-button>
      </template>
...
<script>
import list from "@/components/yx/contract/list";
import editDialog from "@/components/yx/contract/editDialog";
