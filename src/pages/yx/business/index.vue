  ...
  <div>
    <list ref="list" :disabled="!$permission.canRead()">
      <template slot="toolbar-left">
        <el-button @click="create()" type="primary" :disabled="!$permission.canWrite()">登记商机信息</el-button>
      </template>
      <el-table-column
        slot="table"
        label="操作"
...
<script>
import list from "@/components/yx/business/list";
import editDialog from "@/components/yx/business/editDialog";
