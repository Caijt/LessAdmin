            ...
            <template slot="column">
                ...
                >
                    <template slot-scope="{row}">
                        <span class="c-link" @click="openDetails(row.id)">{{row.contract_no}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="project_name"
                ...
                <el-table-column prop="pay_remarks" label="付款备注" width="120" show-overflow-tooltip />
                <el-table-column prop="create_user" width="100" label="录入员" show-overflow-tooltip />
                ...
                <el-table-column prop="pull_time" label="提取时间" width="120" sortable="custom">
                    <template slot-scope="{row}">
                        <span>{{ row.pull_time | formatDate }}</span>
                    </template>
                </el-table-column>
                <!-- slot[column] -->
...
import listMixin from "@/mixins/listDelete";
