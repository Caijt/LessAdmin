<template>
  <div>
    <list
      ...
      :page="page"
      :get-page-list-func="api.getInductionAnalysisList"
    >
      ...
      <template slot="column">
        ...
        <el-table-column prop="newNumber" label="入职人数" />
        <el-table-column v-if="queryParams.dimensions == 1" prop="lastNumber" label="同比入职人数">
