<template>
  <div>
    <list
      ...
      :page="page"
      :get-page-list-func="api.getDimissionAnalysisList"
    >
      ...
      <template slot="column">
        ...
        <el-table-column prop="newNumber" label="离职人数" />
        <el-table-column v-if="queryParams.dimensions == 1" prop="lastNumber" label="同比离职人数">
