<template>
  <div>
    <list
      ...
      :page="page"
      :get-page-list-func="api.getCustomerAnalysisList"
    >
      ...
      <template slot="column">
        ...
        <el-table-column prop="newNumber" label="新增客户数量" />
        <el-table-column v-if="queryParams.dimensions == 2" prop="lastNumber" label="同期新增客户数量">
