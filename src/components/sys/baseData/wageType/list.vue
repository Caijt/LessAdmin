<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getWageTypeList"
      :delete-func="api.deleteWageTypeById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="工资类型名称" sortable="custom" min-width="150"></el-table-column>
