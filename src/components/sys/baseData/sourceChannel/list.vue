...
<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getSourceChannelList"
      :delete-func="api.deleteSourceChannelById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="来源渠道名称" sortable="custom" min-width="150"></el-table-column>
