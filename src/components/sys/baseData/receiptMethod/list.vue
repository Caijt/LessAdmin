...
<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getReceiptMethodList"
      :delete-func="api.deleteReceiptMethodById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="收款方式名称" sortable="custom" min-width="150"></el-table-column>
