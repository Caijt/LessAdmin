...
<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getCustomerTypeList"
      :delete-func="api.deleteCustomerTypeById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="客户类型" sortable="custom" min-width="150"></el-table-column>
