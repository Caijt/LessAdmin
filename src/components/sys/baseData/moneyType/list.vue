<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getMoneyTypeList"
      :delete-func="api.deleteMoneyTypeById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="款项类别名称" sortable="custom" min-width="150"></el-table-column>
