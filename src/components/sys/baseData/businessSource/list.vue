...
<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getBusinessSourceList"
      :delete-func="api.deleteBusinessSourceById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="业务来源名称" sortable="custom" min-width="150"></el-table-column>
