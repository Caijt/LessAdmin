...
<template>
  <div>
    <list
      ...
      :page="false"
      :get-list-func="api.getMetacilTypeList"
      :delete-func="api.deleteMetacilTypeById"
    >
      ...
      <template slot="table">
        <el-table-column prop="name" label="灭害种类名称" sortable="custom" min-width="150"></el-table-column>
