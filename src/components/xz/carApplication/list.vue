  ...
  <div>
    ...
    >
      ...
      <template slot="column">
        ...
        <el-table-column prop="reason" label="用车原因" show-overflow-tooltip sortable="custom" min-width="100"></el-table-column>
        <el-table-column
        ...
        <el-table-column prop="createTime" label="提交时间" sortable="custom" width="140">
