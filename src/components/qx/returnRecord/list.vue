  ...
  <div>
    ...
    >
      ...
      <div slot="query">
        <div>
          ...
          <el-form-item label="归还人">
            <el-input v-model.trim="queryParams.returnEmployeeName" clearable></el-input>
          </el-form-item>
          <el-form-item label="归还部门">
            <el-input v-model.trim="queryParams.returnDepName" clearable></el-input>
          </el-form-item>
      ...
      <template slot="table">
        ...
        />
        <el-table-column prop="returnDepName" label="归还部门" width="150" show-overflow-tooltip />
        <el-table-column prop="reason" label="归还原因" min-width="180" show-overflow-tooltip />
        <el-table-column prop="returnTime" width="140" label="领用时间" sortable="custom">
          <template slot-scope="{ row }">
            <span>{{ row.returnTime | toShortDatetimeString }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="amount" label="归还数量" width="100" sortable="custom" align="center">
          <template slot-scope="{row}">
