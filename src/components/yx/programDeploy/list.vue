  ...
  <div>
    ...
    >
      ...
      <template slot="query">
        ...
        <div>
          ...
          <el-form-item label="预计完成时间" label-width="100px">
            <el-date-picker
              v-model.trim="queryParams.programDate"
              placeholder="填选择时间"
      ...
      <template slot="column">
        ...
        <el-table-column prop="businessProspect" label="是否需勘察" min-width="150">
          <template slot-scope="{row}">
            <el-col v-if="row.businessProspect == 0">无需勘察</el-col>
            <el-col v-else>需要勘察</el-col>
          </template>
        </el-table-column>
        <el-table-column prop="businessProgram" label="是否需方案" min-width="100">
          <template slot-scope="{row}">
            <el-col v-if="row.businessProgram == 0">无需方案</el-col>
